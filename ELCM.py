...
if main_file is not None:
    try:
        ...
        st.write("Columns in main file:", df_main.columns.tolist())
        ...
        if missing_cols:
            ...
            if seating_file is not None:
                try:
                    ...
                    st.write("Columns in seating file:", df_seating.columns.tolist())
                    seating_columns = [
                        'Employee Code',
                        'Building Name',
                        'Floor',
                    ...
                    if missing_seating:
                        ...
                        # Convert Employee Code to string in both dataframes before merging
                        df_main['Employee Code'] = df_main['Employee Code'].astype(str).str.strip()
                        df_seating['Employee Code'] = df_seating['Employee Code'].astype(str).str.strip()
